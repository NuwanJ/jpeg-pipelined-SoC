...
SOPCINFO_FILE := C:/altera/projects/CO503/lab4/HwJSoC.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x8011088
SOPC_SYSID_FLAG += --sidp=0x8011088
ELF_PATCH_FLAG  += --sidp 0x8011088

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1593179949
SOPC_SYSID_FLAG += --timestamp=1593179949
ELF_PATCH_FLAG  += --timestamp 1593179949
...
# setting hal.stdout is jtag_D
ELF_PATCH_FLAG  += --stdout_dev jtag_D
