...
# setting SOPC_SYSID_BASE_ADDRESS is 0x80110a8
SOPC_SYSID_FLAG += --sidp=0x80110a8
ELF_PATCH_FLAG  += --sidp 0x80110a8
...
# setting hal.stdout is jtag_E
ELF_PATCH_FLAG  += --stdout_dev jtag_E
